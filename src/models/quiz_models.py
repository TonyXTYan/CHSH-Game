...
class Answers(db.Model):
    ...
    participant_session_id = db.Column(db.String(100), nullable=False)
...
class PairQuestionRounds(db.Model):
    ...
    participant1_item = db.Column(db.Enum(ItemEnum), nullable=True)
    participant2_item = db.Column(db.Enum(ItemEnum), nullable=True)
