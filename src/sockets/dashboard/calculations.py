"""Heavy dashboard calculations split from the main socket handlers."""
...
def compute_team_hashes(team_name: str) -> Tuple[str, str]:
    ...
    try:
        ...
        from . import _get_team_id_from_name
        ...
        from src.sockets.dashboard import PairQuestionRounds, Answers
...
def _calculate_success_statistics(team_name: str) -> Dict[str, Optional[float]]:
    ...
    try:
        ...
        from . import compute_success_metrics
...
def _process_single_team_optimized(team_id: int, team_name: str, is_active: bool, created_at: Optional[str], current_round: int, player1_sid: Optional[str], player2_sid: Optional[str], team_rounds: List[Any], team_answers: List[Any]) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        from . import _compute_team_hashes_optimized, _compute_correlation_matrix_optimized, _compute_success_metrics_optimized, _calculate_team_statistics_from_data, _calculate_success_statistics_from_data
