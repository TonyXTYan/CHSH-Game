...
function updateGameThemeDisplay(theme, skipDropdownUpdate = false) {
    ...
    if (themeDescription) {
        if (theme === 'food') {
            ...
            themeDescription.innerHTML = `
                <strong>AQM Joe Theme:</strong> Questions about color and food preferences. 
                Success depends on following specific coordination constraints: Green→Peas, never both Peas for food questions.
            `;
        } else {
            themeDescription.innerHTML = `
